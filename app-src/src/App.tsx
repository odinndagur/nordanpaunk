...
function App() {
	const fridayData = [
		...
		['9:00 PM', 'ISKANDR', ''],
		['9:30 PM', '', 'RONJA','https://www.youtube.com/watch?v=ZjFidZbzh70'],
		['10:00 PM', 'HEXHEXHEX', ''],
		['10:30 PM', '', ''],
		['11:00 PM', 'IFFERNET', ''],
		['11:40 PM', '', 'EPIDERMAL VEIL'],
		['12:10 AM', 'GRÓA', ''],
		['12:50 AM', '', 'GUÐIR HINS NÝJA TÍMA','https://www.youtube.com/watch?v=65D8lvWQrIE'],
		['1:20 AM', 'GJÖLL', ''],
		['2:00 AM', '', ''],
	]
	...
	const saturdayData = [
		...
		['3:30 PM', '', ''],
		['4:00 PM', 'SORDIDE', ''],
		['4:30 PM', '', 'GUBBA HORI','https://www.youtube.com/watch?v=GCgH77xkVhE'],
		['5:00 PM', 'MONDERNTE', ''],
		['5:30 PM', '', 'THE BOOB SWEAT GANG', 'https://www.youtube.com/watch?v=rJd7-lvh8E8'],
	...
	const sundayData = [
		...
		['5:00 PM', 'PTHUMULHU', ''],
		['5:30 PM', '', 'FLAARYR','https://www.youtube.com/watch?v=HuIHlqW-47o'],
		['6:00 PM', 'SVARTÞOKA', ''],
		['6:30 PM', '', 'MÓR','https://www.youtube.com/watch?v=c_mUL8grzVw'],
		['7:00 PM', '', ''],
		['7:30 PM', '', ''],
		['8:00 PM', 'ÓREIÐA', ''],
